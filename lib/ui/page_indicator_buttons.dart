...
import 'package:flutter_intro_views/models/page_button_view_model.dart';
...
class PageIndicatorButtons extends StatelessWidget {
  ...
  Widget _getDoneORNextButton() {
    ...
    } else if (activePageIndex == totalPages - 1 || (activePageIndex == totalPages - 2 && slideDirection == SlideDirection.rightToLeft || doneButtonPersist)) {
      return DoneButton(
        child: doneText,
  ...
  Widget _getSkipORBackButton() {
    ...
    } else if ((activePageIndex < totalPages - 1 || (activePageIndex == totalPages - 1 && slideDirection == SlideDirection.leftToRight)) && showSkipButton) {
      return DefaultButton(
        child: skipText,
